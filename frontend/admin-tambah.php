		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="form-group" style="margin-bottom: 80px">
					...
					<div class="col-md-12">
						<?= form_input('title', set_value('title'), array('class'=>'form-control', 'placeholder'=>'Ketik judul artikel')) ?>
						<?= form_error('title') ?>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-12" for="first-name">Konten Berita:</label>
					<div class="col-md-12"><?= $this->ckeditor->editor('content', html_entity_decode(set_value('content'))) ?></div></div>
				</div>
				<div class="form-group">
			...
			<div class="x_content">
				...
				<div class="form-group"><div class="row">
					...
					<div class="col-md-12">
						...
						?>
						<?= form_dropdown('category', $array_kategori, set_value('category'), array('class'=>'form-control')) ?>
						<?= form_error('category') ?>
					</div></div>
				</div>
				<div class="form-group"><div class="row">
					...
					<div class="col-md-12">
						...
						?>
						<?= form_dropdown('active', $array_opsi, set_value('active'), array('class'=>'form-control')) ?>
						<?= form_error('active') ?>
					</div></div>
				</div>
				<div class="form-group"><div class="row">
...
<?php elseif (print_url(3) == 'agenda'): ?>
<!-- type article -->
<?= form_hidden('type', 'agenda') ?>
<?= form_hidden('url', print_url(3)) ?>
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="form-group" style="margin-bottom: 80px">
					...
					<div class="col-md-12">
						<?= form_input('value', set_value('value'), array('class'=>'form-control', 'placeholder'=>'Ketik kategori ')) ?>
						<?= form_error('value') ?>
					</div>
				</div>
			</div>
